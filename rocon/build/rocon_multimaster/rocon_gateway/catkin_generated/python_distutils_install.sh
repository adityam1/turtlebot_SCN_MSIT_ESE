...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_multimaster/rocon_gateway"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_multimaster/rocon_gateway" \
    install \
    $DESTDIR_ARG \
