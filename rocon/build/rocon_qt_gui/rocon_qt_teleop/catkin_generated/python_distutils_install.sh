...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_qt_gui/rocon_qt_teleop"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_qt_gui/rocon_qt_teleop" \
    install \
    $DESTDIR_ARG \
