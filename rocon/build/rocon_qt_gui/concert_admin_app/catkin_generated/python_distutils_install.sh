...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_qt_gui/concert_admin_app"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_qt_gui/concert_admin_app" \
    install \
    $DESTDIR_ARG \
