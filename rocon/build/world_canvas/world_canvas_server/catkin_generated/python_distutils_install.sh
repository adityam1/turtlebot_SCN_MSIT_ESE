...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/world_canvas/world_canvas_server"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/world_canvas/world_canvas_server" \
    install \
    $DESTDIR_ARG \
