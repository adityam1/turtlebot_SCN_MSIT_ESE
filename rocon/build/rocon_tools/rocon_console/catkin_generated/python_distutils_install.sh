...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_tools/rocon_console"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_tools/rocon_console" \
    install \
    $DESTDIR_ARG \
