...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_tools/rocon_python_comms"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_tools/rocon_python_comms" \
    install \
    $DESTDIR_ARG \
