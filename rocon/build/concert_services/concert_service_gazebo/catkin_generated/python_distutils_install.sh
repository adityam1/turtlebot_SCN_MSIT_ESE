...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/concert_services/concert_service_gazebo"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/concert_services/concert_service_gazebo" \
    install \
    $DESTDIR_ARG \
