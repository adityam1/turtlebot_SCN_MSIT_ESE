...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_concert/concert_service_link_graph"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_concert/concert_service_link_graph" \
    install \
    $DESTDIR_ARG \
