...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_concert/concert_schedulers"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_concert/concert_schedulers" \
    install \
    $DESTDIR_ARG \
