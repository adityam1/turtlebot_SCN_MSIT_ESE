...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_concert/concert_service_manager"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_concert/concert_service_manager" \
    install \
    $DESTDIR_ARG \
