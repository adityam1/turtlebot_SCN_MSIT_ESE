...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rqt_capabilities"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rqt_capabilities" \
    install \
    $DESTDIR_ARG \
