...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/rocon_app_platform/rocon_app_manager"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/rocon_app_platform/rocon_app_manager" \
    install \
    $DESTDIR_ARG \
