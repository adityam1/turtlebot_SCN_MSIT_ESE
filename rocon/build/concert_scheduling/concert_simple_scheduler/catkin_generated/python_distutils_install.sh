...
echo_and_run cd "/home/turtlebot/ese_team_project/rocon/src/concert_scheduling/concert_simple_scheduler"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/rocon/build/concert_scheduling/concert_simple_scheduler" \
    install \
    $DESTDIR_ARG \
