...
if("FALSE" STREQUAL "TRUE")
  set(world_canvas_client_py_SOURCE_PREFIX /home/turtlebot/ese_team_project/rocon/src/world_canvas_libs/world_canvas_client_py)
  set(world_canvas_client_py_DEVEL_PREFIX /home/turtlebot/ese_team_project/rocon/devel)
  ...
  set(world_canvas_client_py_INSTALL_PREFIX /home/turtlebot/ese_team_project/rocon/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'world_canvas_client_py' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jorge Santos <jsantossimon@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'world_canvas_client_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/ese_team_project/rocon/install/${idir}'.  Ask the maintainer 'Jorge Santos <jsantossimon@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${world_canvas_client_py_dep}_FOUND)
      find_package(${world_canvas_client_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${world_canvas_client_py_dep} REQUIRED ${depend_list})
  endif()
