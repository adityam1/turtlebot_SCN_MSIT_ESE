...
"""autogenerated by genpy from world_canvas_msgs/Annotations.msg. Do not edit."""
import sys
...
class Annotations(genpy.Message):
  _md5sum = "5b47cb1c51cbc7a899bf81b52bdb8c27"
  _type = "world_canvas_msgs/Annotations"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Semantic map:
#  - geometric map id
...
float64 w
"""
  __slots__ = ['map_id','annotations']
  _slot_types = ['string','world_canvas_msgs/Annotation[]']
