...
int main(int argc, char ** argv) {
    ...
    ros::SCNServiceServer testService = n.advertiseService(gNodeName, testService17, demoNode17CallBack);

    // service called of demo node 9
    std::string testServiceClient17 = "demoNode9TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(gNodeName, testServiceClient17);
