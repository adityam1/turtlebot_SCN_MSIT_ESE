...
int main(int argc, char ** argv) {
    ...
    ros::SCNServiceServer testService = n.advertiseService(gNodeName, testService12, demoNode12CallBack);

    // service called of demo node 10
    std::string testServiceClient12 = "demoNode10TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(gNodeName, testServiceClient12);
