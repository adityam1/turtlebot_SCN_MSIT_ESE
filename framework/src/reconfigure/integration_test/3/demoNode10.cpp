...
int main(int argc, char ** argv) {
    ...
    ros::SCNServiceServer testService = n.advertiseService(gNodeName, testService10, demoNode10CallBack);

    // service called of demo node 9
    std::string testServiceClient10 = "demoNode9TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(gNodeName, testServiceClient10);
