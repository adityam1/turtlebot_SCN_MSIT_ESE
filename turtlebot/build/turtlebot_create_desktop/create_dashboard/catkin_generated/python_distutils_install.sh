...
echo_and_run cd "/home/turtlebot/ese_team_project/turtlebot/src/turtlebot_create_desktop/create_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/turtlebot/build/turtlebot_create_desktop/create_dashboard" \
    install \
    $DESTDIR_ARG \
