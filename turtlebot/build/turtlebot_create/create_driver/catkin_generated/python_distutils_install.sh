...
echo_and_run cd "/home/turtlebot/ese_team_project/turtlebot/src/turtlebot_create/create_driver"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/ese_team_project/turtlebot/build/turtlebot_create/create_driver" \
    install \
    $DESTDIR_ARG \
