...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3f.pack(_x.mode, _x.pano_angle, _x.snap_interval, _x.rot_vel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.pano_angle, _x.snap_interval, _x.rot_vel,) = _struct_B3f.unpack(str[start:end])
      return self
