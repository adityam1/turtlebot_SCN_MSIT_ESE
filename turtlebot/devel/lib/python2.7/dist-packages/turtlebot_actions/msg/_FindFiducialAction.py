...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2BfB3I.pack(_x.action_goal.goal.pattern_width, _x.action_goal.goal.pattern_height, _x.action_goal.goal.pattern_size, _x.action_goal.goal.pattern_type, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.pattern_width, _x.action_goal.goal.pattern_height, _x.action_goal.goal.pattern_size, _x.action_goal.goal.pattern_type, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2BfB3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
