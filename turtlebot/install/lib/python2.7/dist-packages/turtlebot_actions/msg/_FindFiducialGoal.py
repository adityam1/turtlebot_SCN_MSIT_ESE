...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2BfB.pack(_x.pattern_width, _x.pattern_height, _x.pattern_size, _x.pattern_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pattern_width, _x.pattern_height, _x.pattern_size, _x.pattern_type,) = _struct_2BfB.unpack(str[start:end])
      return self
