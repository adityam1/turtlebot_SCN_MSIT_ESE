 ...
 * declaration
 */
bool demoAlgo2ClientCallback(reconfigure::demoAlgoService::Request &req, 
...
int main(int argc, char ** argv) {
    std::string node_name = "demoAlgo2";
    ros::init(argc, argv, node_name);
    ros::NodeHandle n;
    
    // service specified for this node in the reconfigure mode
    gCallbackService = "demoAlgo2Service";
    ros::ServiceServer service = n.advertiseService(gCallbackService, demoAlgo2ClientCallback);
 ...
 */
bool demoAlgo2ClientCallback(reconfigure::demoAlgoService::Request &req, reconfigure::demoAlgoService::Response &res) {
