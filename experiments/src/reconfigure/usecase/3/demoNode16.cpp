 ...
 * declaration
 */
bool demoNode16ClientCallback(reconfigure::demoNodeService::Request &req,
        reconfigure::demoNodeService::Response &res);
bool demoNode16CallBack(reconfigure::demoNodeService::Request &req,
        reconfigure::demoNodeService::Response &res);
...
int main(int argc, char ** argv) {
    ENTER();
    std::string node_name = "demoNode16";
//    ros::init(argc, argv, node_name);
    ...
    ros::SCNServiceServer service = n.advertiseService(node_name, gCallbackService, demoNode16ClientCallback);

    // service provided for demo node 14
    std::string testService16 = "demoNode16TestService";
    ros::SCNServiceServer testService = n.advertiseService(node_name, testService16, demoNode16CallBack);

    // service called of demo node 9
    std::string testServiceClient16 = "demoNode9TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(node_name, testServiceClient16);
 ...
 */
bool demoNode16ClientCallback(reconfigure::demoNodeService::Request &req, reconfigure::demoNodeService::Response &res) {
    ENTER();
    ...
    ROS_INFO("Demo Node 16 Enter safe mode!\n");
 ...
 */
bool demoNode16CallBack(reconfigure::demoNodeService::Request &req, reconfigure::demoNodeService::Response &res) {
    ENTER();
    std::string service = req.callback_service;

    ROS_INFO("Inside demoNode 16 test service!\n");
