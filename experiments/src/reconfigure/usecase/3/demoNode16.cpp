...
int main(int argc, char ** argv) {
    ...
    ros::SCNServiceServer testService = n.advertiseService(gNodeName, testService16, demoNode16CallBack);

    // service called of demo node 9
    std::string testServiceClient16 = "demoNode9TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(gNodeName, testServiceClient16);
