...
int main(int argc, char ** argv) {
    ENTER();
    std::string node_name = "demoNode11";
    ...
    ros::SCNServiceServer service = n.advertiseService(node_name, gCallbackService, demoNode11ClientCallback);

    // service used by demo node 13
    std::string testService11 = "demoNode11TestService";
    ros::SCNServiceServer testService = n.advertiseService(node_name, testService11, demoNode11CallBack);

    // service called of demo node 10
    std::string testServiceClient11 = "demoNode10TestService";
    ros::SCNServiceClient testClient = n.serviceClient<reconfigure::demoNodeService>(node_name, testServiceClient11);
 ...
 */
bool demoNode11ClientCallback(reconfigure::demoNodeService::Request &req, reconfigure::demoNodeService::Response &res) {
    ENTER();
    ...
    ROS_INFO("Demo node 11 Enter safe mode!\n");
