...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NavigateToGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%string location~%int8   approach_type~%int8   num_retry~%float32 timeout~%~%# This variable used when approach near is requested~%float32 distance~%~%int8 APPROACH_NEAR = 11 # Not implemented yet~%int8 APPROACH_ON   = 12~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NavigateToGoal)))
  "Returns full string definition for message of type 'NavigateToGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%string location~%int8   approach_type~%int8   num_retry~%float32 timeout~%~%# This variable used when approach near is requested~%float32 distance~%~%int8 APPROACH_NEAR = 11 # Not implemented yet~%int8 APPROACH_ON   = 12~%~%~%"))
